...
```dockerfile
FROM ghcr.io/multi-py/python-gunicorn:py3.12-24.1.1
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-gunicorn:py3.12-24.1.1`
* Slim Image: `ghcr.io/multi-py/python-gunicorn:py3.12-slim-24.1.1`
