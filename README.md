...
```dockerfile
FROM ghcr.io/multi-py/python-gunicorn:py3.12-25.0.2
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-gunicorn:py3.12-25.0.2`
* Slim Image: `ghcr.io/multi-py/python-gunicorn:py3.12-slim-25.0.2`
