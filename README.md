...
```dockerfile
FROM ghcr.io/multi-py/python-gunicorn:py3.12-25.0.1
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-gunicorn:py3.12-25.0.1`
* Slim Image: `ghcr.io/multi-py/python-gunicorn:py3.12-slim-25.0.1`
...
| 24.0.0 | 3.9 | py3.9-24.0.0 | py3.9-slim-24.0.0 | py3.9-alpine-24.0.0 |
| 24.0.0 | 3.8 | py3.8-24.0.0 | py3.8-slim-24.0.0 | py3.8-alpine-24.0.0 |
