...
```dockerfile
FROM ghcr.io/multi-py/python-gunicorn:py3.12-25.3.0
...
## Tags
* Recommended Image: `ghcr.io/multi-py/python-gunicorn:py3.12-25.3.0`
* Slim Image: `ghcr.io/multi-py/python-gunicorn:py3.12-slim-25.3.0`
...
| 25.3.0 | 3.12 | py3.12-25.3.0 | py3.12-slim-25.3.0 | py3.12-alpine-25.3.0 |
| 25.3.0 | 3.11 | py3.11-25.3.0 | py3.11-slim-25.3.0 | py3.11-alpine-25.3.0 |
| 25.3.0 | 3.10 | py3.10-25.3.0 | py3.10-slim-25.3.0 | py3.10-alpine-25.3.0 |
| 25.3.0 | 3.9 | py3.9-25.3.0 | py3.9-slim-25.3.0 | py3.9-alpine-25.3.0 |
| 25.3.0 | 3.8 | py3.8-25.3.0 | py3.8-slim-25.3.0 | py3.8-alpine-25.3.0 |
| 25.2.0 | 3.12 | py3.12-25.2.0 | py3.12-slim-25.2.0 | py3.12-alpine-25.2.0 |
| 25.2.0 | 3.11 | py3.11-25.2.0 | py3.11-slim-25.2.0 | py3.11-alpine-25.2.0 |
| 25.2.0 | 3.10 | py3.10-25.2.0 | py3.10-slim-25.2.0 | py3.10-alpine-25.2.0 |
| 25.2.0 | 3.9 | py3.9-25.2.0 | py3.9-slim-25.2.0 | py3.9-alpine-25.2.0 |
| 25.2.0 | 3.8 | py3.8-25.2.0 | py3.8-slim-25.2.0 | py3.8-alpine-25.2.0 |
